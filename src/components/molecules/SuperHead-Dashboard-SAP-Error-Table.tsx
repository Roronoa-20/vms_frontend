...
const DashboardSAPErrorTable = ({ dashboardTableData, companyDropdown, team }: Props) => {
  ...
  const fetchTable = async () => {
    ...
    const dashboardTableDataApi: AxiosResponse = await requestWrapper({
      url: `${API_END_POINTS?.PurchaseTeamSAPError}?page_no=${currentPage}&vendor_name=${debouncedSearchName}&team=${normalizedTeam}`,
      method: "GET",
    });
