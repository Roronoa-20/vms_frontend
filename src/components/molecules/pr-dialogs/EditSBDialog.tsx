...
//   item_category_master: DropdownItem[];
//   material_group_master: DropdownItem[];
//   account_assignment_category: DropdownItem[];
//   purchase_organisation:DropdownItem[]
// }
...
//       console.log(response.data, "reposne edit head and upadte")
...
//           {/* Select fields */}
//           {[
//             ["account_assignment_category_head", "Account Assignment Category", Dropdown.account_assignment_category],
//             ["item_category_head", "Item Category", Dropdown.item_category_master],
//             ["uom_head", "UOM", Dropdown.uom_master],
//             ["material_group_head", "Material Group", Dropdown.material_group_master],
//             ["purchase_organisation_head", "Purchase Organisation", Dropdown.purchase_organisation]
...
//                 <SelectContent>
//                   <SelectGroup>
//                     {(options as DropdownItem[]).map((item, i) => (
