...
<ViewPaymentRequisition pickupData={sampleData} />;

interface ViewPaymentRequisitionProps {
...
export default function ViewPaymentRequisition({ pickupData = [] }: ViewPaymentRequisitionProps) {
  ...
  const onNewShipment = () => {
    router.push("/payment-requisition");
  };
