...
export default function UserMaterialRequestForm({ form, masters, MaterialOnboardingDetails, handleMaterialSearch, searchResults, showSuggestions, handleMaterialSelect, materialSelectedFromList, setMaterialSelectedFromList, setMaterialCodeAutoFetched, setShowSuggestions, materialCodeAutoFetched, setSelectedMaterialType, materialCodeStatus, selectedCodeLogic, setSelectedCodeLogic, latestCodeSuggestions }: UserRequestFormProps) {
  ...
  const shouldShowMaterialCode = isCodeGeneratedBySAP || (!isZRND && (selectedMaterialCategory === "R" || selectedMaterialCategory === "P"));
  ...
  useEffect(() => {
    ...
    const prefillForm = async () => {
      ...
      form.reset({
        ...
        material_code_revised: isCodeGeneratedBySAP ? details.material_code_revised || "" : form.getValues("material_code_revised"),
  ...
  useEffect(() => {
    ...
    if (filteredPlants.some(p => p.plant_name === details.plant)) {
      form.setValue("plant_name", details.plant);
    }
  ...
  useEffect(() => {
    if (isCodeGeneratedBySAP) return;

    if (!shouldShowMaterialCode && !isCodeGeneratedBySAP) {
      form.setValue("material_code_revised", "");
  ...
  }, [isCodeGeneratedBySAP, selectedMaterialCategory, selectedMaterialType]);
