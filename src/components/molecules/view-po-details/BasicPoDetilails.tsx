...
const BasicPoDetilails = ({poBasicDetails}: Props) => {
  ...
  return (
    ...
    <div className='bg-white shadow-md border gap-3 p-4 rounded-xl mt-3 mx-2'>
        ...
        <label htmlFor={poBasicDetailsState?.po_mail_sent === 1 ? undefined : 'file'} className={`border-2 border-dashed rounded-xl py-3 px-4 flex justify-center items-center truncate gap-2 bg-[#FCFCFC] ${poBasicDetailsState?.po_mail_sent === 1 ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}>
