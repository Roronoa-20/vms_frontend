              ...
              {table ? (
                table?.map((item, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell className="text-nowrap text-center"><Link href={`/view-quotation?refno=${item?.unique_id}`}><Button className="bg-white text-black hover:bg-white hover:text-black">View</Button></Link></TableCell>
                    {/* <TableCell>
              <div
