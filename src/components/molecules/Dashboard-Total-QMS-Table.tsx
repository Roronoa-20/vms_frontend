...
const DashboardTotalQMSTable = ({ dashboardTableData, companyDropdown }: Props) => {
    ...
    const fetchTable = async () => {
        const dashboardApprovedVendorTableDataApi: AxiosResponse = await requestWrapper({
            url: `${API_END_POINTS?.TotalQMSDocs}?company=${selectedCompany}&vendor_name=${search}&page_no=${currentPage}&page_size=${record_per_page}`,
            method: "GET",
        });
...
export default DashboardTotalQMSTable;
