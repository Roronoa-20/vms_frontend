...
const MaterialRequestTable: React.FC<MaterialRequestTableProps> = ({
    ...
    return (
        <div className="mt-4 bg-white rounded-xl shadow-sm border border-slate-200 p-4 transition-all duration-300 hover:shadow-md">
            ...
            {paginatedData.length ? (
                <Table>
                    <TableHeader>
                        <TableRow className="bg-slate-50/50 border-y border-slate-200">
                            <TableHead className="text-center text-[11px] font-bold uppercase tracking-wider text-slate-500 py-3 text-nowrap">Sr.No.</TableHead>
                            <TableHead className="text-center text-[11px] font-bold uppercase tracking-wider text-slate-500 py-3 text-nowrap">Request ID</TableHead>
                            <TableHead className="text-center text-[11px] font-bold uppercase tracking-wider text-slate-500 py-3 text-nowrap">Request Date</TableHead>
                            <TableHead className="text-center text-[11px] font-bold uppercase tracking-wider text-slate-500 py-3 text-nowrap">Company</TableHead>
                            <TableHead className="text-center text-[11px] font-bold uppercase tracking-wider text-slate-500 py-3 text-nowrap">Material Type</TableHead>
                            <TableHead className="text-center text-[11px] font-bold uppercase tracking-wider text-slate-500 py-3 text-nowrap">Material Description</TableHead>
                            <TableHead className="text-center text-[11px] font-bold uppercase tracking-wider text-slate-500 py-3 text-nowrap">Status</TableHead>
                            <TableHead className="text-center text-[11px] font-bold uppercase tracking-wider text-slate-500 py-3 text-nowrap">View Details</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
