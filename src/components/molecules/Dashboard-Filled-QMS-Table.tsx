...
const DashboardFiiledQMSTable = ({ dashboardTableData, companyDropdown }: Props) => {
    console.log(dashboardTableData, "this is Filled table onboarded");
    ...
    const fetchTable = async () => {
        try {
            const res: AxiosResponse = await requestWrapper({
                url: `${API_END_POINTS?.FullyFilledQMSDocs}?company=${selectedCompany}&vendor_name=${debouncedSearchName}&page_no=${currentPage}&page_size=${record_per_page}`,
                method: "GET",
            });
        ...
        <>
            ...
            <div className="shadow- bg-[#f6f6f7] p-4 rounded-2xl">
                <div className="flex w-full justify-between pb-4">
                    <h1 className="text-[20px] text-[#03111F] font-semibold">QMS Form Filled Vendors</h1>
                                ...
                                <TableRow key={index}>
                                    ...
                                    <TableCell>
                                        <Button
                                            ...
                                            onClick={() => openVendorCodes(item?.company_vendor_codes as any)}
                                        >
                                            View
                                        </Button>
                                    </TableCell>
                                    ...
                                    <TableCell>
                                        <div
                                            className={`${(item?.qms_form_filled && item?.sent_qms_form_link) &&
                                                (item?.company_name == "2000" || item?.company_name == "7000")
                                                ? ""
                                                : "hidden"
                                                }`}
                                        >
...
export default DashboardFiiledQMSTable;