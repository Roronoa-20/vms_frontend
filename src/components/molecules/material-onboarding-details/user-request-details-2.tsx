...
const UserRequestForm: React.FC<UserRequestFormProps> = ({ form, plantcode, AllMaterialType, StorageLocation, AllMaterialCodes, MaterialDetails, MaterialOnboardingDetails, handleMaterialSearch, handleMaterialSelect, searchResults = [], showSuggestions, setShowSuggestions, selectedMaterialType, setSelectedMaterialType, setMaterialCompanyCode, materialCompanyCode, setIsMaterialCodeEdited, setShouldShowAllFields, shouldShowAllFields, setIsMatchedMaterial, materialCodeStatus, selectedCodeLogic, latestCodeSuggestions, materialSelectedFromList, setMaterialCodeAutoFetched, materialCodeAutoFetched }) => {
    ...
    // const isSAPGenerated = !!approvalStatus && approvalStatus !== "Pending by CP";
    ...
    useEffect(() => {
        ...
        if (!hideMaterialCode && !isSAPGenerated) {
            setShouldShowAllFields(shouldShowAll);
        }

        if (!isSAPGenerated && currentCode) {
    ...
    }, [materialCode, materialDesc, isSAPGenerated, originalMaterialCode, originalDesc, AllMaterialCodes, setIsMatchedMaterial, setIsMaterialCodeEdited, setShouldShowAllFields, hideMaterialCode, form]);
    ...
    }, [hideMaterialCode, materialDesc, originalDesc, isSAPGenerated]);
                                        ...
                                        <FormControl>
                                            <div>
                                                <textarea
                                                    ...
                                                    disabled={isSAPGenerated || !hideMaterialCode}
                                                    ref={field.ref}
                                                    value={field.value || ""}
                                                    onChange={(e) => {
                                                        field.onChange(e);
                                                ...
                                                <div className="relative">
                                                    <FormControl>
                                                        <Input
                                                            ...
                                                            disabled={isSAPGenerated || materialCodeAutoFetched}
                                                        />
                                                    </FormControl>

                                                    {!isSAPGenerated && isRevisedNewCode && (
                                                    ...
                                                    {!isSAPGenerated && isRevisedNewCode && latestCodeSuggestions[0] && !materialSelectedFromList && (
