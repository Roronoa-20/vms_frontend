...
import { sidebarMenu, VendorsidebarMenu, EnquirysidebarMenu, HeadSidebar } from "@/src/constants/sidebarMenu";
...
const Sidebar = () => {
  ...
  const sideBar = designation === "Vendor" ? VendorsidebarMenu : designation === "Enquirer" ? EnquirysidebarMenu : designation == "Purchase Head"?HeadSidebar : sidebarMenu;
