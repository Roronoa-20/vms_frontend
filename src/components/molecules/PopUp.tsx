...
const PopUp = ({ handleClose,children,headerText,isSubmit,Submitbutton}: props) => {
  ...
  return (
    ...
    <div ref={DialogRef}  className="bg-white rounded-xl border p-4 md:max-w-[450px] md:max-h-[300px] h-full w-full gap-8 text-black md:text-md font-light">
