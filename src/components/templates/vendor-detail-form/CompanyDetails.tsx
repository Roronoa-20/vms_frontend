      ...
      <form onSubmit={(e) => { handleSubmit(e) }}>
        <div className="grid grid-cols-3 gap-6 p-5 overflow-y-scroll max-h-[70vh]">
          ...
          <div>
            ...
            <Input type="date" placeholder="Enter your CIN Date" max={new Date().toISOString().split("T")[0]} onChange={(e) => { updateField("cin_date", e.target.value) }} value={data?.cin_date ?? OnboardingDetail?.cin_date ?? ""} />
        ...
        <div className="flex justify-end pr-6">
          <Button className={`bg-blue-400 hover:bg-blue-400`} variant="nextbtn" size="nextbtnsize">Next</Button>
        </div>
      </form>
    </div>
  );
