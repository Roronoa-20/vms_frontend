...
export default function Water_Consumption_And_Management() {
    ...
    const { wcmform, updateWcmForm, refreshFormData, updateEceForm, asaFormSubmitData } = useASAFormContext();
    ...
    console.log("Water Consumption and Management Form Data:", wcmform);
