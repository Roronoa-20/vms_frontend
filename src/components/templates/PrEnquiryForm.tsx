  ...
  const addItems = () => {
    ...
    addEnquiryItems(body)
      .then(() => {
        ...
        if (addLoaderRef.current) addLoaderRef.current.className = "hidden";
      })
      .catch(() => {
            ...
            <Button
              ...
              onClick={() => {
                if(submitLoaderRef.current){
                  submitLoaderRef.current.className = "inline-flex animate-spin"
                }
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
            <Card className="bg-white p-6 w-[400px] text-center rounded-lg shadow-lg">
              <CardContent className="p-8 text-center bg-gradient-to-b from-white to-gray-50 rounded-2xl">
                ...
                <p className="text-sm text-gray-600">{"Product Enquiry Submitted Successfully!"}</p>
                <Button
                  className="mt-2"
                  variant="nextbtn"
                  size="nextbtnsize"
