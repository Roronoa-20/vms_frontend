        ...
        <TableBody className="">
          ...
          }
          {
            ...
            <TableRow>
              ...
              <TableCell className="font-medium">
                <Input type="number" className="h-8 text-xs rounded-md px-2" value={singleRowData?.quantity ?? ""} onChange={(e) => { setSingleRowData(prev => ({ ...prev, quantity: Number(e.target.value) } as nbItemsType)) }} />
              </TableCell>
              <TableCell className="font-medium">
                {
                  isPurchaseGroupDropdown ?
                    ...
                    />
                    :
                    <Input value={singleRowData?.purchasing_group ?? ""} className="h-8 text-xs rounded-md px-2" onChange={(e) => { setSingleRowData(prev => ({ ...prev, purchasing_group: e.target.value } as nbItemsType)) }} disabled />
                }
              </TableCell>
              <TableCell className="font-medium">
                <Input type="date"
