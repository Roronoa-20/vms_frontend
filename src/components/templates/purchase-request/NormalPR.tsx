      ...
      <Table className=" max-h-40 overflow-y-scroll border border-black/20">
        <TableHeader className="text-center">
          <TableRow className="bg-[#DDE8FE] text-[#2568EF] text-[14px] hover:bg-[#DDE8FE] text-center text-nowrap">
            ...
            <TableHead className="text-center w-[10%]">Materials</TableHead>
          ...
          <TableRow>
            ...
            <TableCell className="font-medium">
             ...
             value={singleRowData?.plant ?? ""}
              onValueChange={(value)=>{
                setSingleRowData(prev=>({...prev,plant:value} as nbItemsType));
              }}
              >
                <SelectTrigger className="rounded-xl">
                  <SelectValue placeholder="Select" />
            ...
            <TableCell className="font-medium">
                {
                    ...
                    onValueChange={(value)=>{
                      setSingleRowData(prev=>({...prev,purchasing_group:value} as nbItemsType));
                    }}
                    >
                <SelectTrigger className="rounded-xl">
                  <SelectValue placeholder="Select" />
