            ...
            <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-gray-100 shadow-sm overflow-hidden bg-white relative">
                    ...
                    <div className="overflow-x-auto">
                        <Table className="min-w-full text-center text-[13px]">
                            <TableHeader className="bg-[#DDE8FE] text-center border-b border-blue-200 shadow-sm text-black">
                                <TableRow>
                                    <TableHead className="w-[60px] text-black py-4 text-center">Sr. No.</TableHead>
                                    <TableHead className="w-[120px] text-black py-4 text-center">Vendor ID</TableHead>
                                    <TableHead className="min-w-[200px] text-black py-4 text-center">Vendor Name</TableHead>
                                    <TableHead className="min-w-[200px] text-black py-4 text-center">Responsible Users</TableHead>
                                    <TableHead className="w-[140px] text-black py-4 text-center">Status</TableHead>
                                    <TableHead className="w-[100px] text-black py-4 text-center">Actions</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {vendors.length === 0 && !loading ? (
                                    <TableRow>
                                        <TableCell colSpan={6} className="h-32 text-center text-gray-400 italic font-medium">
                                    ...
                                    vendors.map((vendor, index) => {
                                        ...
                                        return (
                                            <React.Fragment key={vendor.vendor_id}>
                                                <TableRow className={cn("hover:bg-gray-50 transition-colors border-b border-gray-50", isExpanded && "bg-[#5291CD]/5 hover:bg-[#5291CD]/10")}>
                                                    <TableCell className="text-center text-gray-500 font-medium font-mono">
                                                        {startIdx + index + 1}
                                                    </TableCell>
                                                    <TableCell className="text-nowrap text-center tracking-tight">
                                                        {vendor.vendor_id}
                                                    </TableCell>
                                                    <TableCell className="text-center tracking-tight">
                                                        {vendor.vendor_name}
                                                    </TableCell>
                                                        ...
                                                        <div className="flex flex-wrap justify-center gap-1.5">
                                                            {vendor.responsible_users.length > 0 ? (
                                                                vendor.responsible_users.map((user, idx) => (
                                                                    <Badge key={idx} variant="outline" className="bg-blue-50/50 text-center text-blue-700 border-blue-100 font-bold px-2 py-0.5 whitespace-nowrap text-[10px]">
                                                                        <User className="w-3 h-3 mr-1 opacity-70" />
                                                                        {typeof user === 'string' ? user : user.employee_name}
                                                                    </Badge>
                                                                ))
                                                            ) : (
                                                                <span className="text-gray-400 text-center italic text-[11px]">Not Assigned</span>
                                                            )}
                                                        </div>
                                                    </TableCell>
                                                    <TableCell className="text-center">
                                                                ...
                                                                <Tooltip>
                                                                    <TooltipTrigger asChild>
                                                                        <button
                                                                            ...
                                                                            className={cn(
                                                                                "flex items-center justify-center w-8 h-8 rounded-lg bg-[#5291CD]/10 border border-[#5291CD]/20 text-[#5291CD] hover:bg-[#5291CD] hover:text-white transition-all shadow-sm",
                                                                                isExpanded && "bg-[#5291CD] text-white"
                                                                            )}
                                                                        >
                                                                    ...
                                                                    <Tooltip>
                                                                        <TooltipTrigger asChild>
                                                                            <button
                                                                                ...
                                                                                className="flex items-center justify-center w-8 h-8 bg-[#5291CD]/10 border border-[#5291CD]/20 rounded-lg text-[#5291CD] hover:bg-[#5291CD] hover:text-white transition-all shadow-sm active:scale-95"
                                                                            >
                                                            ...
                                                            <div className="p-4 bg-white/40 backdrop-blur-sm">
                                                                    ...
                                                                    <div className="px-4 py-3 bg-[#5291CD]/10 border-b border-[#5291CD]/20 flex items-center justify-between">
                                                                        <div className="flex items-center gap-2">
                                                                            ...
                                                                            <div>
                                                                                <h4 className="text-[12px] font-semibold text-black uppercase">Assessment History</h4>
                                                                                <p className="text-[11px] font-medium text-black/60 mt-1">{vendor.vendor_name} ({vendor.vendor_id})</p>
                                                                            </div>
                                                                        </div>
                                                                        <Badge className="bg-white text-[#5291CD] border-[#5291CD]/20 font-black px-2 py-0.5 text-[10px]">
                                                                    ...
                                                                    <Table className="min-w-full">
                                                                        ...
                                                                        <TableBody>
                                                                            {vendor.esg_forms.map((form, fIdx) => (
                                                                                <TableRow key={fIdx} className="hover:bg-[#5291CD]/10 border-b border-gray-50 last:border-0 transition-colors">
                                                                                    <TableCell className="py-4 text-center text-gray-900 font-medium">
                                                                                        {fIdx + 1}
                                                                                    </TableCell>
                                                                                        ...
                                                                                        <div className="flex items-center justify-center gap-3">
                                                                                            {form.form_is_submitted === 0 && asaResponsibleUser === 1 && (
                                                                                                <button
                                                                                                    ...
                                                                                                    className="flex items-center gap-1.5 text-[11px] font-bold text-[#5291CD] hover:bg-[#5291CD]/10 px-3 py-1.5 rounded-lg transition-all"
                                                                                                >
                ...
                {isReminderModalOpen && (
                    ...
                    >
                        <div className="space-y-4 py-2">
                            <div className="bg-gradient-to-br from-[#5291CD]/10 to-[#5291CD]/5 p-4 rounded-2xl border border-[#5291CD]/20 shadow-sm">
                                <p className="text-[10px] text-[#5291CD] font-black uppercase tracking-widest mb-2">Recipient Context</p>
                                <div className="flex items-center gap-3 overflow-hidden">
                                    <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center shadow-sm shrink-0">
                                        <Mail className="w-5 h-5 text-[#5291CD]" />
                                    </div>
                                    <div className="flex flex-col min-w-0">
                                        <span className="text-sm text-gray-900 font-black truncate leading-tight">
                                            {selectedReminderName}
                                        </span>
                                        <span className="text-[10px] font-bold text-[#5291CD] uppercase tracking-tighter italic">ASA Form Submission Request</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full h-32 p-4 text-sm bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-[#5291CD]/10 focus:border-[#5291CD] focus:bg-white transition-all resize-none shadow-inner font-medium outline-none"
                                />
