...
interface Props {
  ...
  multipleCompany: { company: string, company_name: string }[];
...
const CompanyDetailForm = ({ companyDetailDropdown, onboarding_refno, refno, OnboardingDetail, multipleCompany, ismulticompany, onNextTab }: Props) => {
  ...
  const isDisabled = (field: string) => {
    if (NON_EDITABLE_FIELDS.includes(field)) return true;
    return !isEditing;
  };
        ...
        <div className="grid grid-cols-3 gap-6 p-2 max-h-[80vh]">
          ...
          <div className="grid grid-cols-4 gap-1">
            <div className="flex flex-col col-span-1">
              ...
              <Input
                ...
                disabled={isDisabled("vendor_title")}
                onChange={(e) => updateField("vendor_title", e.target.value)}
              />
            </div>
          ...
          <div className="flex flex-col">
            ...
            <Select
              ...
              disabled={isDisabled("type_of_business")}
            >
              <SelectTrigger>
          ...
          <div className="flex flex-col">
            ...
            <Input
              ...
              disabled={isDisabled("registered_office_number")}
          ...
          <div>
            ...
            <Input
              disabled={isDisabled("whatsapp_number")}
          ...
          <div>
            ...
            <Input
              ...
              disabled={isDisabled("established_year")}
          ...
          <div>
            ...
            <Input
              ...
              disabled={isDisabled("office_email_secondary")}
          ...
          <div>
            ...
            <Input
              ...
              disabled={isDisabled("corporate_identification_number")}
          ...
          <div className="flex flex-col">
            ...
            <Select
              ...
              disabled={isDisabled("nature_of_company")}
          ...
          <div className="flex flex-col">
            ...
            <Select
              ...
              disabled={isDisabled("nature_of_business")}
          ...
          <div>
            ...
            {ismulticompany ? (
              <textarea
                ...
                placeholder="Enter Company Name"
                defaultValue={multipleCompany.map((item, index) => item?.company_name) ?? ""}
                disabled={true}
              />
            ) : (
              <Input
