...
const CompanyAddress = ({
  ...
  return (
    <div className="flex flex-col bg-white rounded-lg px-4 pb-4 max-h-[80vh] overflow-y-scroll w-full">
      ...
      <div className="flex justify-between items-center border-b-2 pb-2 mb-4 sticky top-0 bg-white py-4 z-50">
      ...
      <div className="grid grid-cols-4 gap-6 p-5">
        <div className="col-span-2">
          <h1 className="text-[12px] text-[#626973] pb-3">Address 1</h1>
          <Input
            value={
        ...
        <div className="col-span-2">
          <h1 className="text-[12px] text-[#626973] pb-3">Address 2</h1>
          <Input
            value={
        ...
        <div className="col-span-2">
          <h1 className="text-[12px] text-[#626973] pb-3">Pincode</h1>
          <Input
            value={
        ...
        <div className="col-span-2">
          <h1 className="text-[12px] text-[#626973] pb-3">District</h1>
          <Input
            value={
