...
const PRRequestForm = ({Dropdown,PRData}:Props) => {
  ...
  setIndex(-1);
     ...
     const handleSubmit = async()=>{
        ...
        const response:AxiosResponse = await requestWrapper({url:url,data:{data:{...formData,purchase_requisition_form_table:tableData}},method:"POST"});
    ...
    <div className="flex flex-col bg-white rounded-lg px-4 pb-4 max-h-[80vh] overflow-y-scroll w-full">
      ...
      <div className="grid grid-cols-3 gap-6 p-5">
        ...
        <div className="col-span-1">
          ...
          <Select onValueChange={(value)=>{handleSelectChange(value,"purchase_group",true)}} value={singleTableRow?.purchase_group ?? ""}>
            <SelectTrigger>
              <SelectValue placeholder="Select" />
            </SelectTrigger>
            <SelectContent>
