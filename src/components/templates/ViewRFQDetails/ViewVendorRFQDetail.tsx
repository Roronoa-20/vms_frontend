...
const ViewLogisticsRFQDetailsPage = ({ RFQData, refno, Dropdown }: Props) => {
    ...
    return (
        <div className='px-4 pb-6 bg-white'>
            ...
            {RFQData?.status != "Approved" && <div className='flex justify-end py-4'><Button type='button' className={`flex bg-blue-400 hover:bg-blue-400 px-10 font-medium  ${!selectedVendorName ? "cursor-not-allowed" : "cursor-pointer"}`} disabled={!selectedVendorName} onClick={() => setOpen(true)}>Back</Button></div>}
